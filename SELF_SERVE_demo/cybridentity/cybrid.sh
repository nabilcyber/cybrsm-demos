...
CURL="curl -s"
TENANT_ID=aac4113
TENANT_URL=https://$TENANT_ID.my.idaptive.app
TENANT_DOMAIN=cyberark.com.63
ADMIN_USER=jodyhuntatx@$TENANT_DOMAIN
ADMIN_PWD=$(keyring cybrid admpwd)
NEW_USER_PWD=$(keyring cybrid admpwd)
